...
<NSString *> * _Nonnull)ignoredProperties SWIFT_WARN_UNUSED_RESULT;
...
<NSString *> * _Nonnull)indexedProperties SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithArray:(RLMArray

<RLMObject *> * _Nonnull)array OBJC_DESIGNATED_INITIALIZER;
...
<NSString *, RLMSyncUser *> * _Nonnull)all SWIFT_WARN_UNUSED_RESULT;
