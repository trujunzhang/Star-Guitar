...
open class TuningsTypeActionCell: UICollectionViewCell {
...
public struct TuningsTypeActionRow: Row, Equatable {
    ...
    public func render(viewCell: UIView) {
        ...
        let cell = (viewCell as? TuningsTypeActionCell)
