...
extension UIFont {
    ...
    static func resultsCustomTitleFont() -> UIFont {
        return UIFont(font: FontFamily.ErasDemiITC.regular, size: UIFont.adustFontSize(24 + SGScreenLayout.sharedInstance.deviceIndex * 6))
    }
